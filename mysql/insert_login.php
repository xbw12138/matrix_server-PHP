...
if (isset($_POST['user_phone']) && isset($_POST['user_password'])&&isset($_POST['user_signtime'])) {
    $user_phone = $_POST['user_phone'];
    $user_password = $_POST['user_password'];
    $user_signtime = $_POST['user_signtime'];	
    $result = "INSERT INTO user_information(user_phone, user_password, user_signtime) VALUES('$user_phone', '$user_password', '$user_signtime')";
